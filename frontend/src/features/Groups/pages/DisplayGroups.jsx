    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">   
        ...
        <div className="mb-8">
          ...
          {showJoinGroup && <JoinGroup handleShowJoinGroup={handleShowJoinGroup} onGroupJoined={handleGroupJoined}/>}
        </div>
                  ...
                  >
                    <div className='flex items-center gap-3 mb-4'>
                        ...
                        <div>
                            ...
                            <p className='text-zinc-600 text-sm'>{group.member_count} {group.member_count === 1 ? 'Member' : 'Members'}</p>
                        </div>
                    </div>   
